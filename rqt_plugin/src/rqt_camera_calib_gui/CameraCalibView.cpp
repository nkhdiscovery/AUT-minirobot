...
//#include <minirobot_msgs/arm.h>
#include <minirobot_msgs/omnidata.h>
//#include <minirobot_msgs/head.h>
//#include <minirobot_msgs/irsensor.h>
#include <minirobot_msgs/motortorques.h>
...
//#include <minirobot_msgs/slamactionAction.h>
...
//#include "minirobot_msgs/stop.h" //facestop and manualauto service
//#include "minirobot_msgs/command.h" //command service
//#include "minirobot_msgs/maptools.h" //command service
...
{
/*
   minirobot_msgs::maptools srv_map;
...
/*
    ...
    chatter_pub8 = n8.advertise<minirobot_msgs::head>("/AUTROBOTIN_head", 1); //head
...
/*
    ...
    serviceclient_facestop = n_client1.serviceClient<minirobot_msgs::stop>("speechOrFace_Stop");

    ros::NodeHandle n_client2;
    serviceclient_manualauto = n_client2.serviceClient<minirobot_msgs::stop>("manualOrAuto");

    ros::NodeHandle n_client3;
    serviceclient_odometryslam = n_client3.serviceClient<minirobot_msgs::command>("AUTROBOTINSRV_command");

    ros::NodeHandle n_client4;
    serviceclient_map = n_client4.serviceClient<minirobot_msgs::maptools>("AUTROBOTINSRV_maptools");
